...
var sugar_uuid="hi";
		...
		function onResponseReceived1(err, result) {
	 	...
	 	bus.sendMessage("activity.cordova_device",['sugar_version'],onResponseReceived1);
		...
		function onResponseReceived2(err, result) {
	 	...
	 	bus.sendMessage("activity.cordova_device",['sugar_model'],onResponseReceived2);
		...
		function onResponseReceived3(err, result) {
	 	...
	 	bus.sendMessage("activity.cordova_device",['sugar_uuid'],onResponseReceived3);
